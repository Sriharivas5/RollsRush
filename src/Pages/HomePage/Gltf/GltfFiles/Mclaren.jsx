...
Command: npx gltfjsx@6.2.16 mclaren.gltf 
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/mclaren.gltf')
  return (
    <group {...props} dispose={null} rotation={[0.5, -0.9, 0]} position={[1,0,0]} > 
      <group scale={0.015}>
